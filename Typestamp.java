...
/** Typestamps are ordinal numbers that uniquely identify types of parse state.  Their main purpose
  ...
  * The parser treats as concrete all types so defined by Breccia except for jointers and pointers,
  * whose parent type (afterlinker) the parser instead treats as concrete and they as variants of it.
  ...
  *
  * <p>Speed is the reason for treating afterlinkers as concrete.  Doing so allows resolution
...
public class Typestamp {
   ...
   // ━━━  F r a c t a l   s t a r t  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    /** The typestamp of `Afterlinker`.
      */
    public static final int afterlinker          = 0x00; // = ↑



    /** The typestamp of `AlarmPoint`.
      */
    public static final int alarmPoint           = 0x01;



    /** The typestamp of `AsidePoint`.
      */
    public static final int asidePoint           = 0x02;
   ...
   // ━━━  F r a c t a l   e n d  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    /** The typestamp of `Afterlinker.End`.
      */
    public static final int afterlinkerEnd       = 0x0d;



    /** The typestamp of `AlarmPoint.End`.
      */
    public static final int alarmPointEnd        = 0x0e;



    /** The typestamp of `AsidePoint.End`.
      */
    public static final int asidePointEnd        = 0x0f;
